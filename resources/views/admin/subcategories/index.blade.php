                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.subcategories.create',$category -> id)}}"
                                                                class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1">اضافه قسم فرعي</a>
