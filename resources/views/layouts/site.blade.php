...
<!-- js وتكون قيمته عباره عن اسم ومسار ملف  sec  فاننا نظيف هذا العنصر html في ملف خارجي ونريد نربطه بملف js اذ اردنا كتابه اكواد -->
    ...
    <style type="text/css">
        ...
        }#popup-subscribe .modal-dialog .modal-content {background-image: url(/savemart/modules/novthemeconfig/images/newsletter_bg-1.png);
        }
...
<main id="main-site" class="displayhomenovthree">
   ...
   <!-- //الهدر مقسم الي ثلاث حاجات -->
    <header id="header" class="header-3 sticky-menu">
        ...
        @include('front.includes.header-top')<!-- //  include داخل  front في مجلد header-top   نعمل استدعاء لهذا الملف الخاص -->
        @include('front.includes.header-bottom')  <!-- include داخل  front في مجلد header-bottom نعمل استدعاء لهذا الملف الخاص -->
        @include('front.includes.header-center')<!-- //  include داخل  front في مجلد header-center نعمل استدعاء لهذا الملف الخاص -->
